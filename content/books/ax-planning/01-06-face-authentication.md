...
<img
  src="/images/docs/ax-planning/01-06-face-authentication.png"
  alt="얼굴 탐지 및 벡터 추출(FaceNet, ArcFace), 유클리드 거리 기반 유사도 분석을 거쳐 FAISS 등을 활용해 대규모 환경에서 고속으로 본인 여부를 판정하는 얼굴 인증 프로세스 흐름도"
  class="img-small">
