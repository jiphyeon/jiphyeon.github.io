...
여기서 주목할 점은 EU의 규제가 전 세계적으로 영향력을 행사한다는 점이다. 기업들은 유럽 시장 진입을 위해 먼저 EU 기준에 맞춰 기술을 설계하고, 그런 다음 다른 지역에 동일하게 또는 확장 적용하는 방식으로 리스크를 최소화한다. EU가 기준 수출국의 역할을 하고 있는 셈이다. 이처럼 EU 규제가 글로벌 표준으로 확산되는 메커니즘, 즉 전 세계 기업이 자발적으로 따르게 만드는 것을 ‘브뤼셀 효과Brussels Effect’라고 부른다. 
